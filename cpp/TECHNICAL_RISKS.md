...
- Linhas de UTR e cabos ficam compiladas no binario neste slice.
- Entrada decimal e validada com ponto, por exemplo `12.5`.
...
| Dados de tabela | Correcao de UTR/cabos exige recompilacao. | Manter dados centralizados em `TableData.cpp` ate planejar carga externa. |
